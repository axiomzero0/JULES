...
get_filename_component(_realOrig "/usr/lib/llvm-19/lib/cmake/clang" REALPATH)
if(_realCurr STREQUAL _realOrig)
  set(_IMPORT_PREFIX "/usr/lib/llvm-19/lib/cmake/clang")
endif()
unset(_realOrig)
unset(_realCurr)
...
set_target_properties(clangdRemoteIndexProto PROPERTIES
  INTERFACE_LINK_LIBRARIES "protobuf;gpr;grpc;grpc++;absl_synchronization;LLVM"
)
...
set_target_properties(clangdRemoteIndexServiceProto PROPERTIES
  INTERFACE_LINK_LIBRARIES "protobuf;gpr;grpc;grpc++;absl_synchronization;LLVM;\$<LINK_ONLY:clangdRemoteIndexProto>;\$<LINK_ONLY:clangdMonitoringServiceProto>"
)
...
set_target_properties(clangdRemoteIndex PROPERTIES
  INTERFACE_LINK_LIBRARIES "clangdRemoteIndexProto;clangdRemoteIndexServiceProto;clangdRemoteMarshalling;clangDaemon;clangdSupport;LLVM;\$<LINK_ONLY:clang-cpp>"
)
